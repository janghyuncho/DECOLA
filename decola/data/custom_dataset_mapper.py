...
# From https://github.com/facebookresearch/Detic/blob/main/detic/data/custom_dataset_mapper.py. 
...
class CustomDatasetMapper(DatasetMapper):
    ...
    def from_config(cls, cfg, is_train: bool = True):
        ...
        ret.update({
            ...
            'score_thres' : cfg.DATALOADER.PSEUDO_LABEL_TRAINING_SCORE_THRES,
        })
        ...
        if cfg.TEST.JUST_STORE_PREDICTIONS and cfg.GEN_PSEDO_LABELS:
            ret['self_label'] = True 
    ...
    def __call__(self, dataset_dict):
        ...
        try:
            if dataset_dict['width'] == ori_image.shape[0] and dataset_dict['height'] == ori_image.shape[1]:
                dataset_dict['width'] = ori_image.shape[1]
                dataset_dict['height'] = ori_image.shape[0]
            utils.check_image_size(dataset_dict, ori_image)
        except:
            print(dataset_dict['height'], dataset_dict['width'], dataset_dict['file_name'], ori_image.shape, flush=True)
            return 
        ...
        if self.with_ann_type:
            ...
            dataset_dict["ann_type"] = \
                self.dataset_ann[0] if self.self_label else \
        ...
        if self.is_train and ('score' in dataset_dict and dataset_dict['score'] < self.score_thres):
            return 
