...
# From https://github.com/facebookresearch/Detic/blob/main/detic/modeling/roi_heads/zero_shot_classifier.py 
...
class ZeroShotClassifier(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if zs_weight_path == 'rand':
            ...
            # Always not learnable.
            self.register_buffer('zs_weight', zs_weight)
        
        assert self.zs_weight.shape[1] == num_classes, self.zs_weight.shape
    ...
    def from_config(cls, cfg, input_shape):
        return {
            ...
            'zs_weight_path': cfg.MODEL.DETR.ZEROSHOT_WEIGHT_PATH,
            'zs_weight_dim': cfg.MODEL.DETR.ZEROSHOT_WEIGHT_DIM,
            'use_bias': cfg.MODEL.DETR.USE_BIAS,
            'norm_weight': cfg.MODEL.DETR.NORM_WEIGHT,
            'norm_temperature': cfg.MODEL.DETR.NORM_TEMP,
        }
