...
# From https://github.com/facebookresearch/Detic/blob/main/detic/modeling/roi_heads/detic_roi_heads.py 
...
class DeticCascadeROIHeads(CascadeROIHeads):
    ...
    def _forward_box(self, features, proposals, targets=None, 
        ...
        if self.training:
            ...
            if class_ids is not None:
                # For eval-oracle or eval-prompt 
                new_scores = [] 
                for score in scores:
                    new_score = score.new_zeros(score.shape)
                    new_score[:, class_ids] = score[:, class_ids]
    ...
    def forward(self, images, features, proposals, targets=None,
        ann_type='box', classifier_info=(None,None,None), class_ids=None):
        '''
